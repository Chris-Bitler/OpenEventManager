...
/**
 * Class for managing timezone and date conversions
...
class TimezoneService
{
    ...
    /**
     * This is done here because we do not need this unless we are updating the timestamp
     * It is also done here to prevent circular dependency issues
    ...
    /**
     * Convert an epoch timestamp to a date/time string
     * following the datetime-local HTML5 format
     * @param string $timestamp The epoch timestamp
     *
     * @return string The time-date string from the timestamp
     */
    ...
    /**
     * Get the current timezone for the website
     * @return string The current timezone or America/New_York if one isn't set
     */
    ...
    /**
     * Update the timezone for the site
     * Also, refresh date time strings in the database
     * @param string $timezone The timezone to set
     */
    public function setTimezone($timezone)
    {
        $this->settingsService->updateSetting('date.timezone', $timezone);
        if ($this->scheduleService != null) {
            $this->scheduleService->refreshDateTimeStrings();
        }
    }

    /**
     * Convert a PHP timezone to a more friendly timezone format
     * @param string $timezone The PHP timezone string
     * @return string The friendly version of timezone
     * @throws Exception If no matching timezone is found
     */
